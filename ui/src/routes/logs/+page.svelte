<script lang="ts">
	...
	function levelColor(lvl: string): string {
		switch (lvl) {
			...
			case 'warn': return 'var(--color-primary)';
...
<svelte:head><title>System Logs | Hive</title></svelte:head>

<div class="max-w-6xl mx-auto">
	<h2 class="text-xl md:text-2xl font-bold mb-6">System Logs</h2>
	...
	<div class="flex gap-3 mb-4 items-end flex-wrap">
		...
		<button onclick={load}
			...
			style="background-color: var(--color-primary); min-height: 42px;">
	...
	<div class="rounded-lg overflow-hidden" style="background-color: var(--color-surface); border: 1px solid var(--color-border);">
		<div class="overflow-auto" style="max-height: 70vh;">
			<table class="w-full text-xs font-mono" style="min-width: 600px;">
